...
int16_t Adafruit_SSD1306::findWidth(uint8_t deviceInt) {
  switch(deviceInt) {
    case SSD1306_96_16_ID: return 96;
    case SSD1306_128_32_ID: return 128;
    default: return 128;
  }
}

int16_t Adafruit_SSD1306::findHeight(uint8_t deviceInt) {
  switch(deviceInt) {
    case SSD1306_96_16_ID: return 16;
    case SSD1306_128_32_ID: return 32;
    default: return 64;
  }
}

uint8_t Adafruit_SSD1306::findPageEndCommand(uint8_t deviceInt) {
  switch(deviceInt) {
    case SSD1306_96_16_ID: return 1;
    case SSD1306_128_32_ID: return 3;
    default: return 7;
  }
}
